...
silent only
cd /development/cours/L2/systeme4/sgf
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 mon_affiche_SGF.c
badd +1 mon_formater.c
badd +1 mon_ls.c
badd +29 mon_mkdir.c
badd +1 mon_rmdir.c
badd +1 mon_SGF.c
...
badd +0 mon_du.c
badd +0 Makefile
args mon_affiche_SGF.c mon_formater.c mon_ls.c mon_mkdir.c mon_rmdir.c mon_SGF.c
edit mon_SGF.h
...
silent! normal! zE
let s:l = 148 - ((7 * winheight(0) + 8) / 16)
...
setlocal wrapmargin=10
silent! normal! zE
let s:l = 484 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
484
...
setlocal wrapmargin=10
silent! normal! zE
let s:l = 67 - ((36 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
67
...
setlocal wrapmargin=10
silent! normal! zE
let s:l = 57 - ((46 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
normal! 020l
tabedit mon_affiche_SGF.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=10
silent! normal! zE
let s:l = 130 - ((3 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
130
normal! 034l
tabedit mon_formater.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=10
silent! normal! zE
let s:l = 43 - ((3 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
...
setlocal wrapmargin=10
silent! normal! zE
let s:l = 94 - ((31 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
94
